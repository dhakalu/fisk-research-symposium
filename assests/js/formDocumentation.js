...
abstractInstructions = [
    "The expected length of your abstract is about 250 words.",
    "Your abstract should expain the purpose of study clearly.",
    "Abstract should mention the designs and methods used in the study.",
    "You should briefly explain the findings of the study",
    "Future works and conclusion is also required.",
    "Please DONOT include details like authors, grants, advisors, etc in the body of abstract. You have other fields to specifiy those details."
];
